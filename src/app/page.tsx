  ...
  },
  {
    ...
    parameters: [
      ...
      },
      {
        ...
        required: false,
        description: "Device memory hint",
      },
      {
        name: "tachiyomi",
        type: "boolean",
  ...
  },
  {
    ...
    parameters: [
      ...
      },
      {
        ...
        type: "string",
        required: false,
        description: "Bot verification token",
      },
    ],
  },
  {
  ...
  },
  {
    ...
    parameters: [
      ...
      },
      {
        ...
        type: "integer",
        required: true,
        description: "Page number (default: 1, max: 50)",
      },
      {
        name: "limit",
        type: "integer",
        required: true,
        description: "Results per page (default: 15, max: 300)",
      },
      {
        name: "time",
        type: "integer",
      ...
      },
      {
        ...
        type: "number",
        required: false,
        description: "Minimum rating (e.g., 5.7)",
      },
      {
        name: "completed",
        type: "boolean",
